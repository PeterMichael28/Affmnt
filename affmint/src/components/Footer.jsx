...
const Footer = () => {
 ...
 <img src={logo} alt="logo" className='w-[6rem] h-[1.6rem]'/>
                ...
                <ul className='text-white flex flex-col items-start gap-y-7'>
                    <li className='text-[1.1rem] font-bold'>Products</li>
                    <li className='text-[.95rem] font-[500]'>Digital Marketing</li>
                    ...
                    <li className='text-[.95rem] font-[500]'>Affiliate Marketing</li>
                </ul>
                ...
                <ul className='text-white flex flex-col items-start gap-y-7'>
                    ...
                    <li className='text-[.95rem] font-[500]'>Terms & Conditions</li>
            ...
            <div>
                ...
                <div className='flex justify-between md:items-center items-start mt-2 flex-col md:flex-row gap-y-6 font-[500]'>
                    <p className='text-[.75rem] text-white'>Address: 16192 Coastal Highway, Lewes, DE 19958</p>

                    <p className='text-[.75rem] text-white'>© Copyright 2023, All Rights Reserved</p>
                </div>
            </div>
        </footer>
    )
